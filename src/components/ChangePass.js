...
const ChangePass = () => {
    ...
    const handleProfileUpdate = async () => {
        ...
        try {
            ...
            const updatedCustomer = { MaKH, NewPassword: confirmPassword };

            const response = await API.post('/taikhoan/doimatkhau', updatedCustomer, {
                ...
                <div class="container pIHdXn">
                    ...
                    <div class="xMDeox">
                        <div class="profile-container">
                            <h2 class="h2-profile">Đổi Mật Khẩu</h2>

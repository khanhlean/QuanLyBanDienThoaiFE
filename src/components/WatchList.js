                ...
                <div class="watchlist_content">
                    <div class="pl_header">
                        <div class="pl_header__title">
                            <h1 class="title-72">Điện thoại</h1>
                        </div>
                    </div>
                    <div class="pl_watches anchor-plp-sections">
                        <section class="pl_section js-plp-section" data-group="1612">
                            {/* <div class="pl_section__header">
                                <h3 class="pl_section__title title-36-light">Phone</h3>
                            </div> */}
                            <div class="pl_section__elements-wrapper">
                                <ul class="pl_section__elements anchor-plp-list-elements">
                                    {watches.map((watch) => (
                                        /*---------------- 1 đồng hồ test -----------------------------*/
                                        <li key={watch.MaDT} class="ts_watch js-plp-watch">
                                            <Link
                                                to={`/watch/${watch.MaDT}`}
                                            ...
                                            >
                                                <figure class="ts_watch__card">
                                                    ...
                                                    <img src={urlImg + watch.HinhAnh} alt={watch.TenDT} />

                                                    <figcaption>
                                                        {/* <span class="ts_watch__collection label-12">{watch.line.brand.name}</span> */}
                                                        <h2 class="ts_watch__subcollection title-16">{watch.TenDT}</h2>
                                                        ...
                                                        >
                                                            <span class="js-watch-price"> ${watch.Gia}</span>
                                                        </small>
                                                    </figcaption>
                                                </figure>
                                            </Link>
